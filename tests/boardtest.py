...
class TestBoardMethods(unittest.TestCase):
    ...
    def test_add_piece(self):
        ...
        self.assertTrue(board.add_piece(6, 7, 1),error_msg_2)
        self.assertTrue(board.grid[6][7] == 1)
        self.assertFalse(board.add_piece(6, 7, 1),error_msg_1)
